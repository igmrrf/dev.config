...
vim.api.nvim_create_user_command("ToggleFormat", function()
  ...
  desc = "Toggle global auto format-on-save",
})

vim.api.nvim_create_user_command("ToggleBuffFormat", function()
  M.toggue(true)
end, {
  desc = "Toggle curent buffer auto format-on-save",
})
...
function M.info(buf)
  ...
  IgmrrfVim[enabled and "info" or "warn"](
    table.concat(lines, "\n"),
...
function M.format(opts)
  ...
  if not done and opts and opts.force then
    IgmrrfVim.warn("No formatter available", { title = "LazyVim" })
  end
end
